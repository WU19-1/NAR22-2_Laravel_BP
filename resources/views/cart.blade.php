                ...
                <div class="flex flex-col gap-y-4 w-4/6 p-8" style="height: 100%;">
                    ...
                    <div class="grid grid-cols-8 gap-y-4 auto-rows-min overflow-auto items-center justify-center" style="height: 100%;">
                        ...
                        @foreach($items as $item)
                            ...
                            <div class="col-span-1">$ {{$item->book->price}}</div>
                            <div class="col-span-1"><input type="number" value="{{$item->quantity}}"  class="w-1/2 p-2 border rounded"></div>
                            <div class="col-span-1">$ {{$item->book->price * $item->quantity}}</div>
